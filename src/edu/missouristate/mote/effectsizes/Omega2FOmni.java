...
/**
 * Omega-squared, F test omnibus unbiased.
 */
public final class Omega2FOmni extends AbstractNonCentralTest {
    ...
    // *************************************************************************
    /**
     * Initialize a new instance of an Omega2FOmni.
     */
    public Omega2FOmni() {
        super();
        reset();
    ...
    private void calculate() {
        ...
        if (useInputs) {
            ...
            measure = (dfEffect * (testStatistic - 1))
                    / ((dfEffect * (testStatistic - 1)) + (dfTotal + 1));
        }
    ...
    public String getMeasureName() {
        return Constants.OMEGA_LOWER + Constants.SUPERSCRIPT2;
    }
    ...
    public String getTestName() {
        return "F Test Omnibus Unbiased";
    }
    ...
    @NameAnnotation(value = "Lower " + Constants.OMEGA_LOWER
            + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 11)
    @DescriptionAnnotation(value = "Minimum value of " + Constants.OMEGA_LOWER
    ...
    @CategoryAnnotation(value = Constants.OUTPUT_CATEGORY)
    @NameAnnotation(value = Constants.OMEGA_LOWER + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 12)
    @DescriptionAnnotation(value = Constants.OMEGA_LOWER + Constants.SUPERSCRIPT2
            + ".")
    @Override
    ...
    @CategoryAnnotation(value = Constants.OUTPUT_CATEGORY)
    @NameAnnotation(value = "Upper " + Constants.OMEGA_LOWER
            + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 13)
    @DescriptionAnnotation(value = "Maximum value of " + Constants.OMEGA_LOWER
            + Constants.SUPERSCRIPT2 + " on the confidence interval.")
    @Override
