...
/**
 * Partial eta-squared, F test omnibus.
 */
public final class PEta2FEff extends AbstractNonCentralTest {
    ...
    // *************************************************************************
    /**
     * Initialize a new instance of an PEta2FEff.
     */
    public PEta2FEff() {
        super();
        reset();
    ...
    public String getMeasureName() {
        return "Partial " + Constants.ETA_LOWER + Constants.SUPERSCRIPT2;
    }

    @Override
    public String getMeasureSymbol() {
        return Constants.ETA_LOWER + Constants.SUPERSCRIPT2 + "p";
    }

    @Override
    public String getTestName() {
        return "F Test Effects";
    }
    ...
    @NameAnnotation(value = "Lower partial " + Constants.ETA_LOWER
            + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 11)
    @DescriptionAnnotation(value = "Minimum value of partial " + Constants.ETA_LOWER
    ...
    @CategoryAnnotation(value = Constants.OUTPUT_CATEGORY)
    @NameAnnotation(value = "Partial " + Constants.ETA_LOWER + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 12)
    @DescriptionAnnotation(value = "Partial " + Constants.ETA_LOWER + Constants.SUPERSCRIPT2
            + ".")
    @Override
    ...
    @CategoryAnnotation(value = Constants.OUTPUT_CATEGORY)
    @NameAnnotation(value = "Upper partial " + Constants.ETA_LOWER
            + Constants.SUPERSCRIPT2)
    @IndexAnnotation(value = 13)
    @DescriptionAnnotation(value = "Maximum value of partial " + Constants.ETA_LOWER
            + Constants.SUPERSCRIPT2 + " on the confidence interval.")
    @Override
